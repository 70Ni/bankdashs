...
function Avatar({ small, edit, mr }) {
  ...
  const lg = "w-S130 h-S130";
  return (
    <div
      className={`imagewrpr relative ${
        small ? sm : lg
      } object-contain rounded-full`}
    >
      <label for="upload-photo">
        {edit && (
          <div className="editIcon absolute bottom-0 right-0 w-8 h-8 rounded-full flex items-center justify-center bg-blue-500 z-20">
